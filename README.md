...
## Run
```
docker run --name app-server -v app-server:/home/user1/code -p 7001:80 -d agusputra/php:7.4
docker run --name wp -v wp:/home/user1/code -p 7001:80 -d agusputra/php:7.4-wp
```
